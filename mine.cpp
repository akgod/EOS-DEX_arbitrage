...
class [[eosio::contract("mine")]] mine : public eosio::contract {
  ...
  public:     
    ...
    void detect(int64_t time) {                        
      require_auth(get_self()); 
      auto flag =0;
      target_index targets( "12345ss12345"_n, "12345ss12345"_n.value );
      for(auto itr = targets.begin();itr != targets.end();itr++){
          ...
          if( iterator_BOX != pairs.end() && iterator_DFS != markets.end() ){              
              ...
              if(Price_BOX > Price_DFS ){
                ...
                if(Profit > 0.006 && M > 0.2){                  //M至少大于0.0001个，eos的最小交易单位.Profit > 0.0062 && M > 0.2
                  flag =1;
                  auto order_amount = (uint64_t)(10000*M + 0.5);       //order_amount 须为uint64。四舍五入                             
                  action( //统计起初拥有多少EOS，存表
                      permission_level{ get_self(), name("active") },
                      get_self(), name("eosasset"),
                      std::make_tuple((uint64_t)0,name("eosio.token"), name("latelatelate"),EOS_SYMBOL)
                  ).send(); 

                  action(
                      permission_level{ name("latelatelate"), name("active") },
                      name("eosio.token"), name("transfer"),
                      std::make_tuple(name("latelatelate"), DFS_CONTRACT, asset(order_amount,symbol("EOS",4)), itr->DFS_swap_memo)
                  ).send();

                  action(
                      permission_level{ get_self(), name("active") },
                      get_self(), name("tokenasset"),
                      std::make_tuple(itr->token_contract_address, name("latelatelate"),itr->token_symbol)
                  ).send();
                
                  action(
                      permission_level{ get_self(), name("active") },
                      get_self(), name("selltoken"),
                      std::make_tuple(name("latelatelate"), BOX_CONTRACT, itr->token_contract_address, itr->BOX_swap_memo)
                  ).send();   

                  
                  action( //统计最后拥有多少EOS，存表
                      permission_level{ get_self(), name("active") },
                      get_self(), name("eosasset"),
                      std::make_tuple((uint64_t)1,name("eosio.token"), name("latelatelate"),EOS_SYMBOL)
                  ).send(); 

                  //判断eos是否增多，若没有增多，则check回滚 
                  action( 
                      permission_level{ get_self(), name("active") },
                      get_self(), name("judge"),
                      std::make_tuple()
                  ...
                  swaplog("yanghao12345"_n,"swaplog id=" + std::to_string(itr->id) + " Profit=" + std::to_string(Profit) + "  M = " + std::to_string(M) + "  order_amount = " + std::to_string(order_amount));
              ...
              if(Price_BOX < Price_DFS ){
                ...
                if(Profit > 0.006 && M > 0.2){  
                  ...
                  action(
                      permission_level{ name("latelatelate"), name("active") },
                      name("eosio.token"), name("transfer"),
                      std::make_tuple(name("latelatelate"), BOX_CONTRACT, asset(order_amount,symbol("EOS",4)), itr->BOX_swap_memo)
                  ).send();
                  ...
                  action(
                      permission_level{ get_self(), name("active") },
                      get_self(), name("selltoken"),
                      std::make_tuple(name("latelatelate"), DFS_CONTRACT, itr->token_contract_address, itr->DFS_swap_memo)
                  ).send();

                  // action( //test---------------------------------------------------------------------------------------------------
                  //     permission_level{ get_self(), name("active") },
                  //     name("eosio.token"), name("transfer"),
                  //     std::make_tuple(get_self(), name("latelatelate"), asset(100,symbol("EOS",4)), itr->BOX_swap_memo)
                  // ).send();
    ...
    void shoot(int64_t time) {                        
      require_auth(get_self()); 
      auto flag =0;
      hbgbox_index hbgboxs( "12345ss12345"_n, "12345ss12345"_n.value );
              ...
              if(Price_BOX > Price_HBG ){
                ...
                if(Profit > 0.006 && M > 0.2){                  //M至少大于0.0001个，eos的最小交易单位.Profit > 0.001 && M > 0.3
                  ...
                  action(
                      permission_level{ name("latelatelate"), name("active") },
                      name("eosio.token"), name("transfer"),
                      std::make_tuple(name("latelatelate"), HBG_CONTRACT, asset(order_amount,symbol("EOS",4)), itr->HBG_swap_memo)
                  ).send();
              ...
              if(Price_BOX < Price_HBG ){
                ...
                if(Profit > 0.006 && M > 0.2){  
                  ...
                  action(
                      permission_level{ get_self(), name("active") },
                      get_self(), name("selltoken"),
                      std::make_tuple(name("latelatelate"), HBG_CONTRACT, itr->token_contract_address, itr->HBG_swap_memo)
                  ).send();
              ...
              if(Price_BOX < buyprice_NEWDEX){ 
                ...
                if(Profit > 0.005 && M > 0.2){
                  ...
                  action(
                      permission_level{ name("latelatelate"), name("active") },
                      name("eosio.token"), name("transfer"),
                      std::make_tuple(name("latelatelate"), BOX_CONTRACT, asset(order_amount,symbol("EOS",4)), itrboxnew->BOX_swap_memo)
                  ).send();

                  action(
                      permission_level{ get_self(), name("active") },
                      get_self(), name("tokenasset"),
                      std::make_tuple(itrboxnew->token_contract_address, name("latelatelate"),itrboxnew->token_symbol)
                  ).send();
                
                  action(
                      permission_level{ get_self(), name("active") },
                      get_self(), name("selltoken"),
                      std::make_tuple(name("latelatelate"), NEWDEX_CONTRACT, itrboxnew->token_contract_address, itrboxnew->NEWDEX_sell_memo)
                  ).send(); 
                  ...
                  swaplog("yanghao12345"_n,"swaplog id=" + std::to_string(itrboxnew->id) + " Profit=" + std::to_string(Profit) + "  M = " + std::to_string(M) + "  order_amount = " + std::to_string(order_amount));
              ...
              if(Price_BOX > sellprice_NEWDEX){
                ...
                if(Profit > 0.005 && M >0.2 ){ //Profit > 0.001 && M >0.3
                  ...
                  action(
                      permission_level{ name("latelatelate"), name("active") },
                      name("eosio.token"), name("transfer"),
                      std::make_tuple(name("latelatelate"), NEWDEX_CONTRACT, asset(order_amount,symbol("EOS",4)), itrboxnew->NEWDEX_buy_memo)
                  ).send();
                  ...
                  action(
                      permission_level{ get_self(), name("active") },
                      get_self(), name("selltoken"),
                      std::make_tuple(name("latelatelate"), BOX_CONTRACT, itrboxnew->token_contract_address, itrboxnew->BOX_swap_memo)
                  ).send();
      ...
      for(auto itrdfsnew = dfsnews.begin();itrdfsnew != dfsnews.end();itrdfsnew++){
          ...
          if( iterator_DFS != markets.end() && iterator_NEWDEX != exchangepair.end() ){
              ...
              if(Price_DFS < buyprice_NEWDEX){ 
                ...
                //swaplog("yanghao12345"_n,"test-------swaplog id=" + std::to_string(itrdfsnew->id) + " Profit=" + std::to_string(Profit) + "  M = " + std::to_string(M));
                ...
                if(Profit > 0.005 && M > 0.2){
                  ...
                  action(
                      permission_level{ name("latelatelate"), name("active") },
                      name("eosio.token"), name("transfer"),
                      std::make_tuple(name("latelatelate"), DFS_CONTRACT, asset(order_amount,symbol("EOS",4)), itrdfsnew->DFS_swap_memo)
                  ).send();

                  action(
                      permission_level{ get_self(), name("active") },
                      get_self(), name("tokenasset"),
                      std::make_tuple(itrdfsnew->token_contract_address, name("latelatelate"),itrdfsnew->token_symbol)
                  ).send();
                
                  action(
                      permission_level{ get_self(), name("active") },
                      get_self(), name("selltoken"),
                      std::make_tuple(name("latelatelate"), NEWDEX_CONTRACT, itrdfsnew->token_contract_address, itrdfsnew->NEWDEX_sell_memo)
                  ).send();             
                  ...
                  swaplog("yanghao12345"_n,"swaplog id=" + std::to_string(itrdfsnew->id) + " Profit=" + std::to_string(Profit) + "  M = " + std::to_string(M) + "  order_amount = " + std::to_string(order_amount));
              ...
              if(Price_DFS > sellprice_NEWDEX){
                ...
                if(Profit > 0.0050 && M > 0.2 ){ //Profit > 0.001 && M >0.3
                  ...
                  action(
                      permission_level{ name("latelatelate"), name("active") },
                      name("eosio.token"), name("transfer"),
                      std::make_tuple(name("latelatelate"), NEWDEX_CONTRACT, asset(order_amount,symbol("EOS",4)), itrdfsnew->NEWDEX_buy_memo)
                  ).send();
                  ...
                  action(
                      permission_level{ get_self(), name("active") },
                      get_self(), name("selltoken"),
                      std::make_tuple(name("latelatelate"), DFS_CONTRACT, itrdfsnew->token_contract_address, itrdfsnew->DFS_swap_memo)
                  ).send();
    ...
    void judge(){
      ...
      swaplog("yanghao12345"_n,"eosbefore = " + std::to_string(eos_before->balance.amount) + " eosafter = " + std::to_string(eos_after->balance.amount) );
    ...
    void getdata(uint64_t pair_id){
      ...
      swaplog("latelatelate"_n,"buyprice=" + std::to_string(buy_price) + " buyamount=" + std::to_string(buy_amount) + " sellprice " + std::to_string(sell_price) + "  sellamount = " + std::to_string(sell_amount));
    }
    ...
    //  swaplog("latelatelate"_n,"token.symbol=" + std::to_string(token_itr->balance.symbol.code().raw()) + " token.amount=" + std::to_string(token_itr->balance.amount) );
    }
